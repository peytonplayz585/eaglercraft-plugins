THIS PLUGIN IS A VERY IMPORTANT SECURITY FEATURE!!!
...
Either don't use /op and install an actual permissions plugin, or move "BitchFiler.jar" into the bukkit_server's "/plugins" folder and use only lowercase letters in your /op profile names!
